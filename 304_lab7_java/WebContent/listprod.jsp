        ...
        if (name != "null" && !name.equals("") && !name.isEmpty()) {
			...
			while (productResultSet.next()) {
				...
				if (session.getAttribute("authenticatedUser") != null) {
					...
					out.println("<tr><td><a href='addcart.jsp?logged=True&id=" + productId +
							"&name=" + URLEncoder.encode(productName, "UTF-8") +
							"&price=" + productPrice + "' style='color:#5f8057'>Add to Cart</a></td><td><a href='product.jsp?logged=True&id=" + productId + "' style='color:#769d6d'>" + productName + "</a></td><td>" + NumberFormat.getCurrencyInstance().format(productPrice) + "</td></tr>");
				} else {
					// Create links for each product
					out.println("<tr><td><a href='addcart.jsp?id=" + productId +
							"&name=" + URLEncoder.encode(productName, "UTF-8") +
							"&price=" + productPrice + "' style='color:#5f8057'>Add to Cart</a></td><td><a href='product.jsp?id=" + productId + "' style='color:#769d6d'>" + productName + "</a></td><td>" + NumberFormat.getCurrencyInstance().format(productPrice) + "</td></tr>");
				}
			}
