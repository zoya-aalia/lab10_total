    ...
    try (Connection connection = DriverManager.getConnection(url, uid, pw); Statement stmt = connection.createStatement();) {
        ...
        try {
            ...
            if (!first.isEmpty() && !last.isEmpty() && pass.equals(password)) {
                ...
                shipmentStmt.setString(1, address);
                shipmentStmt.setString(2, city);
                shipmentStmt.setString(3, state);
                shipmentStmt.setString(4, postalCode);
                shipmentStmt.setString(5, country);
                shipmentStmt.setString(6, custId);
